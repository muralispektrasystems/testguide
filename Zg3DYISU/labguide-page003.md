...
<inject key="azureaduserpassword"/> 
<inject value="value@123" /><inject cloudname="AZURE" enableCopy="true" enableClickToPaste="false" defaultValue="accesskey"/>
...
On the **Sign in to Microsoft Azure** window, you will see the login screen, enter the following username and click on Next
...
<inject key="AzureAdUserPassword" value="random" />
